...
const Footer = (): JSX.Element => (
    ...
    <footer className="text-blueGray-700 transition duration-500 ease-in-out transform w-full">
      <div className="container flex flex-col flex-wrap p-8 mx-auto md:items-center lg:items-start md:flex-row md:flex-no-wrap ">
        <div className="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
          <div className="pr-2 lg:pr-8 lg:px-6">
            ...
            <p className="mb-10 text-xs font-semibold tracking-widest text-black uppercase title-font ">
        ...
        <div className="flex flex-wrap flex-grow mt-8 -mb-10 text-left md:pl-20 md:mt-0 ">
          <div className="w-full px-4 lg:w-1/3 md:w-1/2">
            <h1 className="mb-8 text-xs font-semibold tracking-widest text-black uppercase title-font">
              {" "}
              Product{" "}
            </h1>
            <nav className="mb-10 space-y-4 list-none">
              <li>
                <a className=" mr-1 text-sm text-blueGray-500 transition duration-500 ease-in-out transform rounded-sm focus:shadow-outline focus:outline-none focus:ring-2 ring-offset-current ring-offset-2">
                  Email Templates
                </a>
              </li>
              <li>
